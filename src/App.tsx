      ...
      <div className="container mx-auto px-4 py-10">
        <header className="mb-10">
          <div className="flex items-center justify-between mb-4">
            <Github
              className={`w-10 h-10 mr-2 ${theme === "light" ? "text-gray-800" : "text-white"}`}
            />
            <h1
              className={`text-3xl font-bold ${theme === "light" ? "text-gray-800" : "text-white"}`}
            >
          ...
          <p
            className={`${theme === "light" ? "text-gray-600" : "text-gray-300"} max-w-2xl mx-auto`}
          >
            Upload your GitHub Actions usage CSV file to analyze workflow
        ...
        <main className="space-y-8">
          {!hasData && (
            <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
              <h2
                className={`text-xl font-semibold mb-4 flex items-center ${theme === "light" ? "text-gray-800" : "text-gray-800"}`}
              >
              ...
              {isLoading && (
                <div
                  className={`mt-4 flex justify-center items-center ${theme === "light" ? "text-indigo-600" : "text-indigo-400"}`}
                >
